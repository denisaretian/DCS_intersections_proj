...
public class Project_Intersection1 {
    public static void main(String[] args) {

        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Project Intersection_1";
        ...
        OP1.SetName("OP1");
        OP1.Value = new TransferOperation("localhost", "4080", "in1");
        ...
        OP2.SetName("OP2");
        OP2.Value = new TransferOperation("localhost", "4080", "in2");
        ...
        OP3.SetName("OP3");
        OP3.Value = new TransferOperation("localhost", "4080", "in3");
        ...
        OP4.SetName("OP4");
        OP4.Value = new TransferOperation("localhost", "4080", "in4");
        ...
        PO4N.SetName("PO4N");
        PO4N.Value = new TransferOperation("localhost", "1081", "P_a2");
        ...
        DataCar p_g4in = new DataCar();
        p_g4in.SetName("P_g4in");
        pn.PlaceList.add(p_g4in);
...
//		t2.Delay = 3;
        ...
        grdT_g4n.Activations.add(new Activation(t_g4n, "P_o4Exit", TransitionOperation.PopElementWithTarget, "P_g4in"));
        grdT_g4n.Activations.add(new Activation(t_g4n, "P_o4Exit", TransitionOperation.PopElementWithTarget, "P_a5"));
        ...
        PetriTransition t_g4in = new PetriTransition(pn);
        t_g4in.TransitionName = "T_g4in";
        t_g4in.InputPlaceName.add("P_g4in");

        Condition T_g4inCt1 = new Condition(t_g4in,"P_g4in",TransitionCondition.NotNull);

        GuardMapping grdT_g4in = new GuardMapping();
        grdT_g4in.condition = T_g4inCt1;
        grdT_g4in.Activations.add(new Activation(t_g4in, "P_g4in", TransitionOperation.SendOverNetwork, "PO4N"));
        t_g4in.GuardMappingList.add(grdT_g4in);

        t_g4in.Delay = 0;
        pn.Transitions.add(t_g4in);
