...
public class Project_Intersection2 {
    public static void main(String[] args) {

        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Project Intersection_2";
        ...
        OP1.SetName("OP1");
        OP1.Value = new TransferOperation("localhost", "4081", "in1");
        ...
        OP2.SetName("OP2");
        OP2.Value = new TransferOperation("localhost", "4081", "in2");
        ...
        OP3.SetName("OP3");
        OP3.Value = new TransferOperation("localhost", "4081", "in3");
        ...
        OP4.SetName("OP4");
        OP4.Value = new TransferOperation("localhost", "4081", "in4");
        ...
        DataTransfer PO2N = new DataTransfer();
        PO2N.SetName("PO2N");
        PO2N.Value = new TransferOperation("localhost", "4081", "P_a4");
        pn.PlaceList.add(PO2N);
        ...
        DataCar p_g2in = new DataCar();
        p_g2in.SetName("P_g2in");
        pn.PlaceList.add(p_g2in);
...
//		t2.Delay = 3;
        ...
        Condition T_g2nCt1 = new Condition(t_g2n,"P_o2Exit",TransitionCondition.NotNull);

        GuardMapping grdT_g2n = new GuardMapping();
        grdT_g2n.condition = T_g2nCt1;
        grdT_g2n.Activations.add(new Activation(t_g2n, "P_o2Exit", TransitionOperation.PopElementWithTarget, "P_g2in"));
        grdT_g2n.Activations.add(new Activation(t_g2n, "P_o2Exit", TransitionOperation.PopElementWithTarget, "P_a5"));
        t_g2n.GuardMappingList.add(grdT_g2n);
        ...
        PetriTransition t_g2in = new PetriTransition(pn);
        t_g2in.TransitionName = "T_g2in";
        t_g2in.InputPlaceName.add("P_g2in");

        Condition T_g2inCt1 = new Condition(t_g2in,"P_g2in",TransitionCondition.NotNull);

        GuardMapping grdT_g2in = new GuardMapping();
        grdT_g2in.condition = T_g2inCt1;
        grdT_g2in.Activations.add(new Activation(t_g2in, "P_g2in", TransitionOperation.SendOverNetwork, "PO2N"));
        t_g2in.GuardMappingList.add(grdT_g2in);

        t_g2in.Delay = 0;
        pn.Transitions.add(t_g2in);
        ...
        t_g5.InputPlaceName.add("P_a5");
        t_g5.InputPlaceName.add("P_x5");

        Condition T_g5Ct1 = new Condition(t17, "P_a5", TransitionCondition.NotNull);
        Condition T_g5Ct2 = new Condition(t17, "P_x5", TransitionCondition.CanAddCars);
        T_g5Ct1.SetNextCondition(LogicConnector.AND, T_g5Ct2);

        GuardMapping grdT_g5 = new GuardMapping();
        grdT_g5.condition = T_g5Ct1;
        grdT_g5.Activations.add(new Activation(t_g5, "P_a5", TransitionOperation.AddElement, "P_x5"));
        t_g5.GuardMappingList.add(grdT_g5);
        ...
        PetriTransition t_g5e = new PetriTransition(pn);
        t_g5e.TransitionName = "T_g5e";
        t_g5e.InputPlaceName.add("P_x5");

        Condition T_g5eCt1 = new Condition(t_g5e, "P_x5", TransitionCondition.HaveCarForMe);

        GuardMapping grdT_g5e = new GuardMapping();
        grdT_g5e.condition = T_g5eCt1;
        grdT_g5e.Activations.add(new Activation(t_g5e, "P_x5", TransitionOperation.PopElementWithTarget, "P_o5"));
        t_g5e.GuardMappingList.add(grdT_g5e);

        t_g5e.Delay = 0;
        pn.Transitions.add(t_g5e);
